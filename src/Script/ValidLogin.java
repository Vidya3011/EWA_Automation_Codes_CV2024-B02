...
public class ValidLogin extends BaseTest {
	...
	public void testValidLogin() throws Exception {
		 ...
		 * Reporter.log("Username:" + un, true); String pw = Lib.getCellValue(xlpath,
		 * "ValidLogin", i, 1); Reporter.log("Password:" + pw, true); String roomname =
		 * Lib.getCellValue(xlpath, "ValidLogin", i, 2); Reporter.log("Room:" +
		 * roomname, true); LoginPage login = new LoginPage(driver);
		 * login.SetUserName(un); login.SetPassword(pw); login.SetSelectRooms(roomname);
		 * Thread.sleep(3000); login.CheckRememberMe(un, pw); Thread.sleep(2000);
		 * login.ClickLoginButton(un, pw, roomname); NodeCreation create1 = new
		 * NodeCreation(driver); create1.testCreateNode();
		 */
