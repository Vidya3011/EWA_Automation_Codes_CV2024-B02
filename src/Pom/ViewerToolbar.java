...
public class ViewerToolbar {
	...
	/*
	 * @FindBy(xpath = ("//span[contains(@class,'shareIcon')]")) private WebElement
	 * shareicon;
	 */
	...
	/*
	 * @FindBy(xpath=("//span[contains(text(),'Mail...')]")) private WebElement
	 * Mail;
	 */

	/*
	 * @FindBy(xpath=("//span[contains(text(),'Print...')]")) private WebElement
	 * PrintDialog;
	 */
	...
	/*
	 * @FindBy(xpath=("//span[contains(text(),'Export...')]")) private WebElement
	 * ExportDialog;
	 */
	...
	public void SetSplitPageTiff(String fileName, int pos) throws Exception {
		...
		WebElement checkbox = driver.findElement(By.xpath(
				"//body/div[@id='main']/div[@id='bodyMain']/div[@id='viewerDiv']/div[@id='docViewerMetaData']/div[@id='"
						+ fileName + "']/div['" + pos + "']/input['" + pos + "']"));
		WebElement thumbnail = driver.findElement(By.xpath(
				"//body/div[@id='main']/div[@id='bodyMain']/div[@id='viewerDiv']/div[@id='docViewerMetaData']/div[@id='"
						+ fileName + "']/div['" + pos + "']/img['" + pos + "']"));
	...
	public void SetSplitPagePdf(String fileName, String StartPage, String EndPage, int pos) throws Exception {
		...
		/*
		 * WebElement msgBox =
		 * driver.findElement(By.xpath("//button[@id=CommentsMessageModelOk']"));
		 * if(msgBox.isDisplayed()) { msgBox.click();
		 */
		// }
	}
