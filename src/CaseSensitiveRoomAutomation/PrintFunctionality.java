...
public class PrintFunctionality extends Generic.BaseClass {
	...
	public void Email_Reference() throws Exception {
		Print pojo = new Print();
		 ...
		 jsclick(pojo.getCaseRoomNishRCab());
			Thread.sleep(3000);
			 jsclick(pojo.getCAseRoomNishDrawerIcon());
			Thread.sleep(3000);
			movingDoublecli(pojo.getCAseRoomNishRExpIcon(), pojo.getCAseRoomNishRExpIcon());
			Thread.sleep(5000);
		jsclick(pojo.getOpenCaseCabDocument());
		Thread.sleep(7000);
		try {
